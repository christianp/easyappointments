...
class Timezones {
    ...
    protected $timezones = [
        ...
        'America' => [
            ...
            'America/Knox_IN' => 'Knox IN (-6:00)',
            'America/Managua' => 'Managua (-6:00)',
            'America/Menominee' => 'Menominee (-6:00)',
            'America/Merida' => 'Merida (-6:00)',
            'America/Mexico_City' => 'Mexico City (-6:00)',
            'America/Monterrey' => 'Monterrey (-6:00)',
            'America/Rainy_River' => 'Rainy River (-6:00)',
            'America/Rankin_Inlet' => 'Rankin Inlet (-6:00)',
            ...
            'America/Fort_Wayne' => 'Fort Wayne (-5:00)',
            'America/Grand_Turk' => 'Grand Turk (-5:00)',
            ...
            'America/New_York' => 'New York (-5:00)',
            ...
            'America/Thunder_Bay' => 'Thunder Bay (-5:00)',
            ...
            'America/Port_of_Spain' => 'Port of Spain (-4:00)',
            'America/Porto_Acre' => 'Porto Acre (-4:00)',
            'America/Porto_Velho' => 'Porto Velho (-4:00)',
            'America/Puerto_Rico' => 'Puerto Rico (-4:00)',
            'America/Rio_Branco' => 'Rio Branco (-4:00)',
            'America/Santiago' => 'Santiago (-4:00)',
            'America/Santo_Domingo' => 'Santo Domingo (-4:00)',
            'America/St_Barthelemy' => 'St Barthelemy (-4:00)',
            'America/St_Kitts' => 'St Kitts (-4:00)',
            'America/St_Lucia' => 'St Lucia (-4:00)',
            'America/St_Thomas' => 'St Thomas (-4:00)',
            'America/St_Vincent' => 'St Vincent (-4:00)',
            'America/Thule' => 'Thule (-4:00)',
            'America/Tortola' => 'Tortola (-4:00)',
            'America/Virgin' => 'Virgin (-4:00)',
            'America/St_Johns' => 'St Johns (-3:-30)',
            'America/Araguaina' => 'Araguaina (-3:00)',
            'America/Bahia' => 'Bahia (-3:00)',
            'America/Belem' => 'Belem (-3:00)',
            'America/Buenos_Aires' => 'Buenos Aires (-3:00)',
            ...
            'America/Sao_Paulo' => 'Sao Paulo (-3:00)',
        ...
        'Antarctica' => [
            ...
            'Antarctica/South_Pole' => 'South Pole (+12:00)',
        ],
        'Atlantic' => [
            'Atlantic/Bermuda' => 'Bermuda (-4:00)',
            'Atlantic/Stanley' => 'Stanley (-4:00)',
            'Atlantic/South_Georgia' => 'South Georgia (-2:00)',
            'Atlantic/Azores' => 'Azores (-1:00)',
            'Atlantic/Cape_Verde' => 'Cape Verde (-1:00)',
            ...
            'Atlantic/St_Helena' => 'St Helena (+0:00)',
            'Atlantic/Jan_Mayen' => 'Jan Mayen (+1:00)',
        ],
        'Brazil' => [
        ...
        'Africa' => [
            ...
            'Africa/Addis_Ababa' => 'Addis Ababa (+3:00)',
        ...
        'Europe' => [
            ...
            'Europe/Isle_of_Man' => 'Isle of Man (+0:00)',
            ...
            'Europe/San_Marino' => 'San Marino (+1:00)',
        ...
        'Asia' => [
            ...
            'Asia/Ho_Chi_Minh' => 'Ho Chi Minh (+7:00)',
            'Asia/Hovd' => 'Hovd (+7:00)',
            ...
            'Asia/Ulan_Bator' => 'Ulan Bator (+8:00)',
        ...
        'Australia' => [
            ...
            'Australia/Broken_Hill' => 'Broken Hill (+9:30)',
            ...
            'Australia/Lord_Howe' => 'Lord Howe (+10:30)',
        ],
    ];
